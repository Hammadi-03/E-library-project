...
export const Book = ({
  ...
  const _color = color ? color : variant === "simple" ? "#f9fafb" : "#d97706";
    ...
    <div className="inline-block w-fit group" style={{ perspective: "1000px" }}>
      <div
        ...
        style={{ 
          ...
          height: typeof _width === 'number' ? `${_width * 1.22}px` : "auto",
          containerType: "inline-size" 
        }}
      >
        <div
          className="flex flex-col h-full rounded-l-md rounded-r overflow-hidden bg-[#f9fafb] shadow-book translate-x-0 relative after:absolute after:border after:border-black/10 after:w-full after:h-full after:shadow-book-border after:rounded-l-md after:rounded-r"
          style={{ width: typeof _width === 'number' ? `${_width}px` : _width }}
        >
          <div
            className={clsx(
