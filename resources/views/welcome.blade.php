        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex-1 max-w-lg mx-8 hidden lg:block">
                    <form action="{{ route('books') }}" method="GET" class="relative">
                        ...
                        <input type="text" name="search" 
                               class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-full leading-5 bg-gray-50 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:border-red-900 focus:ring-1 focus:ring-red-900 sm:text-sm" 
